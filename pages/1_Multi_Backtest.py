...
@@ -1334,20 +1334,37 @@ def sync_cashflow_from_first_portfolio_callback():
...
@@ -1358,16 +1375,31 @@ def sync_rebalancing_from_first_portfolio_callback():
...
@@ -1530,8 +1562,8 @@ def map_frequency(freq):
...
@@ -1544,6 +1576,9 @@ def map_frequency(freq):
...
@@ -1570,6 +1605,10 @@ def map_frequency(freq):
...
@@ -1586,6 +1625,9 @@ def update_active_portfolio_index():
else:
...
def update_name():
@@ -1700,6 +1742,76 @@ def update_first_rebalance_strategy():
...
@@ -1754,6 +1866,40 @@ def update_collect_dividends_as_cash():
...
@@ -1814,6 +1960,51 @@ def update_collect_dividends_as_cash():
...
@@ -1923,6 +2114,85 @@ def update_stock_dividends(index):
...
@@ -2073,6 +2343,13 @@ def update_momentum_weight(index):
...
@@ -2750,8 +3027,8 @@ def map_frequency(freq):
...
@@ -2765,6 +3042,9 @@ def map_frequency(freq):
...
@@ -2808,6 +3088,10 @@ def map_frequency(freq):
...
@@ -2832,6 +3116,13 @@ def clean_portfolio_configs_for_export(configs):
# Update global settings from session state
cleaned_config['start_with'] = st.session_state.get('multi_backtest_start_with', 'all')
cleaned_config['first_rebalance_strategy'] = st.session_state.get('multi_backtest_first_rebalance_strategy', 'rebalancing_date')
...
@@ -2945,21 +3236,48 @@ def get_no_additions_series(obj):
...
@@ -3151,9 +3469,17 @@ def clamp_stat(val, stat_type):
...
@@ -3179,36 +3505,129 @@ def clamp_stat(val, stat_type):
cols.remove(c)
cols = front + cols
...
@@ -3374,6 +3793,171 @@ def color_gradient_stock(val):
...
st.markdown(
@@ -3716,7 +4300,7 @@ def prepare_bar_data(d):
